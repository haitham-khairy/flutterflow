...
class AlarmsWidget extends StatefulWidget {
  ...
  static String routeName = 'Alarms';
  static String routePath = '/alarms';
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(65.0, 5.0, 0.0, 5.0),
                        child: Text(
                          'Alarms',
                          style:
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                FlutterFlowDropDown<String>(
                                  controller:
                                      _model.selectLineValueController ??=
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                FlutterFlowDropDown<String>(
                                  controller:
                                      _model.selectSKUValueController ??=
                                          FormFieldController<String>(
                                ...
                                Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    cursorColor: FlutterFlowTheme.of(context)
                                        .primaryText,
                                    validator: _model
                                        .selectIDTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ],
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Container(
                    ...
                    child: Builder(
                      builder: (context) {
                        final alarmsList = FFAppState().AlarmsList.toList();

                        return FlutterFlowDataTable<AlarmTypeStruct>(
                          ...
                          dataRowHeight: 65.0,
                          columnSpacing: 5.0,
                          headingRowColor: Color(0xFF0000A0),
                          borderRadius: BorderRadius.circular(8.0),
