...
import 'update_bin_status_widget.dart' show UpdateBinStatusWidget;
import 'package:flutter/material.dart';

class UpdateBinStatusModel extends FlutterFlowModel<UpdateBinStatusWidget> {
  ...
  // Stores action output result for [Custom Action - getstatus] action in UpdateBinStatus widget.
  String? getStatusResponse;
  // Stores action output result for [Custom Action - readtagcount] action in UpdateBinStatus widget.
  List<RFIDTagsdataStruct>? rfidtagdata;
  // Stores action output result for [Backend Call - API (GetTagsData)] action in UpdateBinStatus widget.
  ApiCallResponse? getTagsDataResponse;
  // Stores action output result for [Backend Call - API (UpdateWorkingBins)] action in Button widget.
  ApiCallResponse? updateWorkingBinsResponse;
