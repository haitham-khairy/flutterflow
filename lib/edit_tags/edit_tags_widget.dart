...
class EditTagsWidget extends StatefulWidget {
  ...
  static String routeName = 'EditTags';
  static String routePath = '/editTags';
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(60.0, 5.0, 0.0, 5.0),
                        child: Text(
                          'Edit Bins',
                          style:
                                ...
                                if ((_model.textController3.text !=
                                  ...
                                  if (_model.selectLineValue != null &&
                                    ...
                                    await showDialog(
                                      ...
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          title: Text('Error'),
                                          content: Text('Select A Line First!'),
                                          actions: [
                                            TextButton(
                                              onPressed: () => Navigator.pop(
                                                  alertDialogContext),
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title: Text('Error'),
                                        content: Text('Enter Number Of Days!'),
                                        actions: [
                                          TextButton(
                                            onPressed: () => Navigator.pop(
                                                alertDialogContext),
